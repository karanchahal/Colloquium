...
return ssc_pulse_(x);}
var isIE11=!!navigator.userAgent.match(/Trident\/7\./);if(!$.browser.msie&&!$.browser.opera&&!isIE11){ssc_addEvent("mousedown",ssc_mousedown);ssc_addEvent("mousewheel",ssc_wheel);ssc_addEvent("load",ssc_init);}
